...
export const metadata: Metadata = {
  title: "Premier Cars - Luxury & Family Vehicles | Clean Car Showroom",
  description: "Discover your perfect car at Premier Cars. Browse our premium collection of luxury sedans, sports cars, and family SUVs. Competitive financing and exceptional service.",
  keywords: "car showroom, luxury cars, family vehicles, car financing, auto dealership, premium cars, test drive",
  metadataBase: new URL("https://premiercars.com"),
  alternates: {
    canonical: "https://premiercars.com"
  },
  openGraph: {
    title: "Premier Cars - Clean Car Showroom Experience",
    description: "Find your dream car with our premium collection and exceptional service. Financing available with competitive rates.",
    url: "https://premiercars.com",
    siteName: "Premier Cars",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763151334318-t94u87xz.jpg",
      alt: "Premium car showroom interior"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Premier Cars - Clean Car Showroom",
    description: "Discover luxury and family vehicles with exceptional service and financing options.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763151334318-t94u87xz.jpg"]
  },
  robots: {
    index: true,
    follow: true
